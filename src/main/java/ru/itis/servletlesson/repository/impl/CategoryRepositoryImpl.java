package ru.itis.servletlesson.repository.impl;
...
public class CategoryRepositoryImpl implements CategoryRepository {
    ...
    public Integer addCategoryAndGetId(String categoryName) {
        ...
        jdbcTemplate.update(con -> {
            PreparedStatement ps = con.prepareStatement(SQL_INSERT_CATEGORY, new String[]{"id"});
    ...
    public void saveProductCategories(Long productId, List<CategoryRequest> categories) {
        categories.forEach(category -> {
            ...
            jdbcTemplate.update(SQL_INSERT_PRODUCT_CATEGORY, productId, categoryId);
        });
